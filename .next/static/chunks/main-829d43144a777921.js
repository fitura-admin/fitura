  ...
  [792],
  {
    ...
    8276: (e, t, r) => {
      ...
      async function D(e) {
        ...
        let { pathname: r } = (0, E.parsePath)(e.asPath),
          ...
          o = (0, R.addBasePath)((0, b.addLocale)(n, e.locale));
      ...
      function F(e, t, r) {
        let [n, o] = (0, O.resolveHref)(e, t, !0),
          ...
          u = o && o.startsWith(a);
        ((n = U(n)), (o = o ? U(o) : o));
        let l = i ? n : (0, R.addBasePath)(n),
          s = r ? U((0, O.resolveHref)(e, r)) : o || n;
        return { url: l, as: u ? s : (0, R.addBasePath)(s) };
      }
      function k(e, t) {
        ...
        let t = await e.fetchData(),
          r = await (function (e, t, r) {
            let n = {
              ...
              l = t.headers.get(x.MATCHED_PATH_HEADER);
            if (
              (!l ||
                u ||
        ...
        async change(e, t, r, n, o) {
          ...
          try {
            ...
            if (
              ...
              let e = (0, v.hasBasePath)(ee.pathname)
        ...
        async getRouteInfo(e) {
          ...
          try {
            ...
            if (
              ...
              return T.effect;
            if (
              (null == T || null == (R = T.effect) ? void 0 : R.type) ===
              "rewrite"
            ) {
          ...
          ((this.sdc = {}),
            ...
            (this.onPopState = (e) => {
              ...
              (!this.isSsr ||
                ...
                l !== (0, R.addBasePath)(this.pathname)) &&
    ...
    9525: (e, t, r) => {
              ...
              children: (0, m.jsx)(U.PathnameContextProviderAdapter, {
                ...
                children: (0, m.jsx)(F.PathParamsContext.Provider, {
                  ...
                  children: (0, m.jsx)(P.RouterContext.Provider, {
                    ...
                    children: (0, m.jsx)(b.HeadManagerContext.Provider, {
                      value: l,
                      children: (0, m.jsx)(M.ImageConfigContext.Provider, {
                        value: {
                          deviceSizes: [
      ...
      let Y = (e) => (t) => {
        ...
        return (0, m.jsx)(z, { children: V(e, r) });
      };
      function K(e) {
        let { App: t, err: u } = e;
        return (
          ...
          i
            ...
            .then((n) => {
              ...
              return (null == s ? void 0 : s.Component) === o
                ? r
                    .e(341)
                    .then(r.t.bind(r, 9341, 23))
                    .then((n) =>
                      r
                        .e(472)
                        .then(r.t.bind(r, 472, 23))
            ...
            .then((r) => {
              ...
              return Promise.resolve(
                ...
                ea({ ...e, err: u, Component: l, styleSheets: s, props: t }),
              );
            })
        );
      }
      ...
      function ea(e) {
            ...
            (0, m.jsxs)(z, {
              children: [
                ...
                (0, m.jsx)(j.Portal, {
                  ...
                  children: (0, m.jsx)(w.RouteAnnouncer, {}),
                }),
              ],
            }),
          ],
        ...
        let P =
          ((t = ee ? er : en),
          (0, m.jsx)(eo, { callbacks: [t, _], children: b }));
        return (
          Z
            ? (0, g.default.startTransition)(() => {
                Z.render(P);
              })
            : ((Z = E.default.hydrateRoot(y, P, {
