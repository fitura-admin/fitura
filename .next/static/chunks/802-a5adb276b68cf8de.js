  ...
  [802],
  {
    802: (t, e, r) => {
      ...
      var n,
        ...
        B = function (t, e) {
          var r = { target: t, props: [], revert: k, save: S };
          return (
        ...
        Z = function (t, e, r, n, s, i) {
          var a = new f.J7(t._pt, e, r, 0, 1, i ? M : w);
        ...
        U = function t(e, r, s, i) {
          ...
          if (
            ...
            return (
              (o = c ? e.getBBox()[v ? "width" : "height"] : e[x]),
              (0, f.E_)(b ? (h / o) * 100 : (h / 100) * o)
            );
          if (
            ((d[v ? "width" : "height"] = 100 + (_ ? g : i)),
            (l =
              ("rem" !== i && ~r.indexOf("adius")) ||
              ("em" === i && e.appendChild && !y)
                ? e
                : e.parentNode),
          ...
          if (b && ("height" === r || "width" === r)) {
            ...
            ((b || "%" === g) &&
              ...
              (d.position = "absolute"));
          return (
            v && b && (((p = (0, f.a0)(l)).time = f.au.time), (p.width = l[x])),
            (0, f.E_)(_ ? (o * h) / 100 : o && h ? (100 / o) * h : 0)
          );
        },
        $ = function (t, e, r, n) {
          var s;
        ...
        Q = function (t, e, r, n) {
          ...
          var a,
            ...
            m,
            v,
            y = new f.J7(this._pt, t.style, e, 0, 1, f.l1),
            x = 0,
            _ = 0;
          if (
            ((y.b = r),
        ...
        tr = {
          clearProps: function (t, e, r, n, s) {
            if ("isFromStart" !== s.data) {
              var i = (t._pt = new f.J7(t._pt, e, r, 0, 0, te));
              return (
                (i.u = n),
                (i.pr = -10),
                (i.tween = s),
        ...
        ta = function (t) {
          var e = V(t, F);
          return ti(e) ? tn : e.substr(7).match(f.vX).map(f.E_);
        },
        to = function (t, e) {
          var r,
            n,
                ...
                a &&
                  (n
                    ...
                    : r
                      ? r.appendChild(t)
                      : s.removeChild(t))),
              e && p.length > 6 ? [p[0], p[1], p[4], p[5], p[12], p[13]] : p);
        },
        tl = function (t, e, r, n, s, i) {
          ...
          (r
            ? u !== tn &&
              (o = m * x - v * y) &&
              ((l = (x / o) * w + (-y / o) * M + (y * b - x * _) / o),
              (p = (-v / o) * w + (m / o) * M - (m * b - v * _) / o),
              (w = l),
              (M = p))
            : ((w =
            ...
            n || (!1 !== n && f.smooth)
              ? ((f.xOffset = g + ((_ = w - c) * m + (b = M - h) * y) - _),
                (f.yOffset = d + (_ * v + b * x) - b))
            ...
            i &&
              (Z(i, f, "xOrigin", c, w),
              Z(i, f, "yOrigin", h, M),
              Z(i, f, "xOffset", g, f.xOffset),
              Z(i, f, "yOffset", d, f.yOffset)),
        ...
        tp = function (t, e) {
          ...
          return (
            ...
            b !== tn &&
              ...
              6 === b.length
                ...
                : ((J = b[6]),
                  ...
                  (u = (O = g(J, q)) * c),
                  O &&
                    ((S = Y * (w = Math.cos(-O)) + B * (M = Math.sin(-O))),
                    (X = z * w + N * M),
                    (k = J * w + q * M),
                    (B = -(Y * M) + B * w),
                    (N = -(z * M) + N * w),
                  ...
                  (d = (O = g(-P, q)) * c),
                  O &&
                    ((S = A * (w = Math.cos(-O)) - B * (M = Math.sin(-O))),
                    (X = E * w - N * M),
                    (k = P * w - q * M),
                    (I = C * M + I * w),
                    (A = S),
                  ...
                  u &&
                    ...
                    ((u = l = 0), (d = 180 - d)),
                  (a = (0, f.E_)(Math.sqrt(A * A + E * E + P * P))),
                  (o = (0, f.E_)(Math.sqrt(z * z + J * J))),
            ...
            (r.rotationX = (0, f.E_)(u) + "deg"),
            (r.rotationY = (0, f.E_)(d) + "deg"),
            (r.skewX = m + "deg"),
            (r.skewY = v + "deg"),
            ...
            (r.renderTransform = r.svg ? td : p ? tg : tc),
            (r.uncache = 0),
            r
          );
        },
        ...
        tu = function (t, e, r) {
          var n = (0, f.l_)(e);
          return (
            (0, f.E_)(parseFloat(e) + parseFloat(U(t, "x", r + "px", n))) + n
          );
        },
        tc = function (t, e) {
          ((e.z = "0px"),
        ...
        tg = function (t, e) {
          ...
          if (x && (f !== th || p !== th)) {
            var O,
              ...
              M = Math.sin(w),
              A = Math.cos(w);
            ((i = tu(y, i, -(M * (O = Math.cos((w = parseFloat(f) * h))) * x))),
              (a = tu(y, a, -(-Math.sin(w) * x))),
              (o = tu(y, o, -(A * O * x) + x)));
          }
        ...
        td = function (t, e) {
          ...
          ((g = parseFloat(g)),
            ...
            ((A && !~(u + "").indexOf("px")) ||
              (E && !~(c + "").indexOf("px"))) &&
              ((A = U(x, "x", u, "px")), (E = U(x, "y", c, "px"))),
            (_ || b || O || w) &&
              ((A = (0, f.E_)(A + _ - (_ * r + b * s) + O)),
              (E = (0, f.E_)(E + b - (_ * n + b * i) + w))),
            (l || p) &&
              ((a = x.getBBox()),
              (A = (0, f.E_)(A + (l / 100) * a.width)),
              (E = (0, f.E_)(E + (p / 100) * a.height))),
            (a =
              "matrix(" +
              r +
              "," +
            ...
            (i = c[s]) !== (a = n[s]) &&
              ...
              ((o =
                (0, f.l_)(i) !== (p = (0, f.l_)(a))
                  ...
                  : parseFloat(i)),
              (l = parseFloat(a)),
              (t._pt = new f.J7(t._pt, n, s, o, l - o, x)),
              (t._pt.u = p || 0),
              t._props.push(s));
          tv(n, c);
        };
      ...
      var tx = {
        ...
        init: function (t, e, r, n, s) {
          ...
          e))
            if (
              "autoRound" !== g &&
              ((o = e[g]), !(f.wU[g] && (0, f.Zm)(g, e, r, n, t, s)))
            ) {
              if (
                ((c = typeof o),
                (h = tr[g]),
                ...
                ((a = (getComputedStyle(t).getPropertyValue(g) + "").trim()),
                  (o += ""),
                  (f.qA.lastIndex = 0),
                  f.qA.test(a) || ((d = (0, f.l_)(a)), (m = (0, f.l_)(o))),
                ...
                if (
                  ...
                  if (
                    ...
                    ((this._pt = new f.J7(
                      ...
                      "scaleY",
                      A.scaleY,
                      (_ ? (0, f.B0)(A.scaleY, _ + l) : l) - A.scaleY || 0,
                      x,
                    )),
                      (this._pt.u = 0),
                      Y.push("scaleY", g),
                    ...
                    (C.push(T, 0, z[T]),
                      ...
                      A.svg
                        ...
                        : ((m = parseFloat(o.split(" ")[2]) || 0) !==
                          ...
                          Z(this, z, g, tf(a), tf(o))));
                    continue;
                  } else if ("svgOrigin" === g) {
                    tl(t, o, 1, E, 0, this);
                    continue;
                  } else if (g in ts) {
                    tm(this, A, g, p, _ ? (0, f.B0)(p, _ + o) : o);
                    continue;
                ...
                if (
                  w ||
                  ((l || 0 === l) && (p || 0 === p) && !v.test(o) && g in z)
                )
                  ((d = (a + "").substr((p + "").length)),
                    l || (l = 0),
                    (m = (0, f.l_)(o) || (g in f.Yz.units ? f.Yz.units[g] : d)),
                    d !== m && (p = U(t, g, a, m)),
                    (this._pt = new f.J7(
                      this._pt,
                      w ? A : z,
      ...
      ((f.os.utils.checkPrefix = D),
        (f.os.core.getStyleSaver = B),
        (function (t, e, r, n) {
          var s = (0, f.fA)(t + "," + e + "," + r, function (t) {
            u[t] = 1;
          });
          ((0, f.fA)(e, function (t) {
        ...
        f.os.registerPlugin(tx));
      var t_ = f.os.registerPlugin(tx) || f.os;
      t_.core.Tween;
    },
  },
]);
