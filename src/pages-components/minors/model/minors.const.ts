...
export const ruMinorsText = `
ПРАВИЛА ПРИНЯТИЯ ПУБЛИЧНОЙ ОФЕРТЫ
ДЛЯ ПОСЕЩЕНИЯ ФИТНЕС-КЛУБА FITURA ДЛЯ НЕСОВЕРШЕННОЛЕТНИХ (14–17 лет)
Приложение и неотъемлемая часть публичного предложения
...
4. Возрастные ограничения и доступ к услугам
...
5. Регистрация в Клубе и обработка данных
...
export const enMinorsText = `
TERMS FOR ACCEPTANCE OF THE PUBLIC OFFER (CONCLUSION OF AGREEMENT)
FOR VISITING THE FITURA FITNESS CLUB
FOR MINORS (14–17 YEARS OLD)

(Approved on January 14, 2026 by decision of the Fitura SIA Board)
Annex and integral part of the Public Offer
...
3. Responsibility for Obligations
...
4. Age Restrictions and Access to Services
...
5. Registration at the Club and Data Processing
...
export const lvMinorsText = `

NOTEIKUMI PUBLISKĀ PIEDĀVAJUMA PIEŅEMŠANAI (LIGUMA SLĒGŠANAI) 
KLUBA FITURA FITNESS APMEKLĒŠANAI
NEPILNGADĪGĀM (14–17 gadi) PERSONĀM 

                                                   
                                                                       Publiskā piedāvājuma 
(apstiprināti 2026. gada 14. janvārī ar valdes lēmumu)
 pielikums un neatņemama sastāvdaļa
...
4. Vecuma ierobežojumi un piekļuve pakalpojumiem
...
5. Reģistrācija Klubā un datu apstrāde
...
export const minorsTexts: Record<LangT, string> = {
  ru: ruMinorsText,
  lv: lvMinorsText,
  en: enMinorsText,
};
